/*
  ...
  This is an example of the dynamic MDNS service lookup/query feature.
  ...
  if ((p_pMDNSResponder) &&
    ...
    if (true == p_bProbeResult) {
      ...
      if (!bHostDomainConfirmed) {
        ...
        if (MDNSResponder::updateDomain(pcHostDomain, "-", 0)) {
...
void setup(void) {
  ...
  if ((!MDNSResponder::updateDomain(pcHostDomain, 0, "esp8266")) ||
